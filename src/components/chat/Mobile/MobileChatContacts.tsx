...
export const MobileChatContacts = (props: IProps) => {
	...
	if (props.loading && !(props.chats[0] === 'null')) {
		...
		return <div style={{ textAlign: 'center' }}> Please Reload Chat!</div>;
	} else {
		return (
			<React.Fragment>
							...
							<div onClick={() => props.onChatSelect(chat)}>
								<Grid centered columns='16'>
									<Grid.Column width='4' verticalAlign='middle'>
										...
										>
											<img
												src={chat.imageURL ? chat.imageURL : undefined}
												alt='contactPicture'
									...
									<Grid.Column floated='right' width='12'>
										<Grid columns='16'>
											<Grid.Column
												...
												width='12'
											>
												<strong style={{ fontSize: '16px', margin: '0px' }}>
													{' '}
													{chat.name}{' '}
												</strong>
											</Grid.Column>
